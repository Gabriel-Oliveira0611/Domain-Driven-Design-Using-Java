...
public class Lancha {
    ...
    public void alterarInformacoes(String modelo, int quantidadeLugares, double comprimento,  int anoFabricacao, int quantidadeMotores) {
        this.modelo = modelo;
